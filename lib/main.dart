      ...
      home: Scaffold(
          body: Container (
            ...
            child: Column(children: [
              ...
              SizedBox(height: 20,),
              Text('Введите логин и пароль, выданный администратором системы',
              ...
              SizedBox(height: 62,),
              InkWell(child: Text('Забыли пароль?', style: LinktestSt,),
                  onTap: () {}),
              SizedBox(height: 20,),
              InkWell(child: Text('Обратиться к разработчику', style: LinktestSt,),
                  onTap: () {}),
            ],),
          )
      ),
